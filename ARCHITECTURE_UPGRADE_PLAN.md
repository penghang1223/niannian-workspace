...
| **娜尔** (product_manager) | 产品 | Qwen3.5-Plus | 需求分析、PRD | 无独立记忆/进化 |
| **开发工程师** (dev_engineer) | 后端 | Qwen-Coder-Next | 代码实现 | 无独立知识库 |
| **本尔** (qa_engineer) | 测试 | Qwen3.5-Plus | 测试分析 | 无测试用例库 |
| **夕尔** (frontend_dev) | 前端 | Qwen-Coder-Next | UI实现 | 无设计模式库 |
...
│   │   └── lessons.md     ← 经验教训
│   │
│   ├── product_manager/   ← 娜尔的产品知识
│   │   ├── domain.md      ← 业务领域知识
│   │   ├── patterns.md    ← 需求分析模式
│   │   └── prd-templates.md ← PRD模板库
│   │
│   ├── dev_engineer/      ← 开发工程师的技术库
...
| Agent | 优先进化方向 | 学习资源 |
|-------|------------|---------|
| **娜尔** | 需求拆解精度、用户故事编写 | PRD模板、竞品分析案例 |
| **开发工程师** | 代码模式库、架构决策能力 | 设计模式、最佳实践 |
| **本尔** | 测试策略、自动化能力 | 测试框架、边界case库 |
| **夕尔** | 组件设计、响应式布局 | UI库、设计系统 |
...
| 协作模式 | 现状 | 升级后 |
|---------|------|--------|
| Bug→用例 | main中转 | 本尔直接读娜尔的PRD写用例 |
| 代码审查 | main分配 | 开发工程师和夕尔直接互审 |
| 需求澄清 | main传话 | 娜尔直接问开发可行性 |
| 测试反馈 | main汇总 | 本尔直接写review给开发 |
